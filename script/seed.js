...
async function seed() {
  ...
  const rice = await Promise.all([
    ...
    Rice.create({
      ...
      description:
        'White jasmine rice is white, has a jasmine flower aroma and, when cooked, a slightly sticky texture. The aroma is caused by the evaporation of 2-Acetyl-1-pyrroline.'
    }),
    Rice.create({
      ...
      description:
        'Brown jasmine rice retains the light tan outer layer on the rice grain. It has greater health benefits than white jasmine rice because it still has the bran.'
    }),
    Rice.create({
      ...
      description:
        'Basmati is a variety of long, slender-grained aromatic rice. Cooked grains of Basmati rice are characteristically free flowing rather than sticky. Structurally, basmati rice has the longest grains of any rice, and it is known for lengthening during cooking.'
    }),
    Rice.create({
      ...
      description:
        'Basmati is a variety of long, slender-grained aromatic rice. Cooked grains of Basmati rice are characteristically free flowing rather than sticky. Brown basmati also has a more nutty flavor and a firmer texture than white.'
    }),
    Rice.create({
      name: 'Black Rice',
      price: 20,
